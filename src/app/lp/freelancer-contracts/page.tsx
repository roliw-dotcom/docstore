...
export const metadata: Metadata = {
  title: "Never Miss a Client Contract Deadline Again — bAInder",
  description:
    "bAInder reads your freelance contracts and tells you every deadline, payment term, and renewal clause — before it costs you.",
};
...
export default function FreelancerContractsLandingPage() {
  return (
    <LandingPageShell
      ...
      subheadline="Client contracts, invoices, insurance, platform agreements — each one has clauses that cost you if you miss them. bAInder reads every document and tells you what to do and when."
      bullets={[
      ...
      quote="I forgot to invoice a client within the payment window specified in the contract. bAInder would have flagged that clause on day one."
    />
  );
}
