...
export const metadata: Metadata = {
  title: "KI liest deinen Mietvertrag — bAIndly",
  description:
    "bAIndly analysiert deinen Mietvertrag mit KI und erkennt automatisch alle Fristen, Klauseln und Pflichten — bevor sie dich Geld kosten.",
};
...
export default function MietvertragKiLandingPage() {
  return (
    <LandingPageShell
      ...
      subheadline="Kündigungsfristen, Nebenkostenabrechnungen, Schönheitsreparaturen, Renovierungspflichten — bAIndly liest deinen Mietvertrag und erklärt dir genau, was wann fällig ist."
      bullets={[
      ...
      quote="Ich hätte Hunderte Euro für Schönheitsreparaturen zahlen müssen, die laut Vertrag gar nicht fällig waren. bAIndly hätte das sofort erkannt."
    />
  );
}
