...
export const metadata: Metadata = {
  title: "Stop Losing Money to the Fine Print — bAInder",
  description:
    "bAInder reads your contracts, leases, and agreements — and tells you every deadline before it costs you. Free for your first 10 documents.",
};
...
export default function FinePrintLandingPage() {
  return (
    <LandingPageShell
      ...
      subheadline="Every lease, contract, and agreement you sign has clauses that cost you if you miss them. bAInder reads every document and alerts you before any deadline — so nothing slips through."
      bullets={[
      ...
      quote="I almost paid €1,200 because I missed one clause in my gym contract. bAInder would have caught it."
    />
  );
}
