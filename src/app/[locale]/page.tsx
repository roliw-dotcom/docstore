...
export default async function RootPage({
  ...
  return (
    <div style={{ background: "#0F2337", color: "white" }}>
      ...
      {/* ── Hero ── */}
      <section className="grid grid-cols-1 md:grid-cols-2" style={{ minHeight: "520px" }}>
        ...
        <div style={{ position: "relative", overflow: "hidden", minHeight: "520px", display: "flex", alignItems: "center" }}>
          <BinderChaosStack />
          {/* gradient: opaque centre-left → transparent right edge so binders peek through */}
          <div style={{
            position: "absolute", inset: 0, zIndex: 9,
            background: "linear-gradient(100deg, rgba(10,25,41,0.88) 0%, rgba(10,25,41,0.75) 55%, rgba(10,25,41,0.25) 100%)",
          }} />
