        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            {(!pendingOnly || pending.length > 0) && (
              <section>
                <h2 style={{ fontSize: "0.75rem", fontFamily: "monospace", letterSpacing: "0.12em", textTransform: "uppercase", color: "#6B7280", marginBottom: "10px" }}>
                  {t("pending")} <span style={{ color: "rgba(0,0,0,0.3)" }}>({pending.length})</span>
                </h2>
                <div style={{ background: "#FFFFFF", border: "1px solid rgba(0,0,0,0.08)", borderRadius: "10px", padding: "0 16px" }}>
            ...
            {!pendingOnly && completed.length > 0 && (
              <section>
                <h2 style={{ fontSize: "0.75rem", fontFamily: "monospace", letterSpacing: "0.12em", textTransform: "uppercase", color: "#6B7280", marginBottom: "10px" }}>
                  {t("completed")} <span style={{ color: "rgba(0,0,0,0.3)" }}>({completed.length})</span>
                </h2>
                <div style={{ background: "#FFFFFF", border: "1px solid rgba(0,0,0,0.08)", borderRadius: "10px", padding: "0 16px" }}>
